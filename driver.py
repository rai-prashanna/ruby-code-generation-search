...
from CodeUtility import transform_data_to_vector_embedding_using_azure_open_ai_model, \
    transform_query_to_vector_embedding_using_azure_open_ai_model
...
# natural_language_vector_embedding=transform_data_to_vector_embedding_using_azure_open_ai_model(natural_language_representations)
# print("Done with generating text representations...")
# print("Generating Code embedding ...")
# code_snippets_vector_embedding=transform_data_to_vector_embedding_using_azure_open_ai_model(code_snippets)
# print("Done with Code embedding ...")
#
...
natural_language_query_vec = transform_query_to_vector_embedding_using_azure_open_ai_model(query)
